...
- Умная генерация карты высот, рельефа и рек
- Полный процесс работы с регионами / странами / стратегическими зонами
- Экспорт полного МОДа из 2000+ файлов за 5 секунд
- Двуязычный интерфейс: китайский / английский""",
    "welcome_features_title": "Возможности",
    "welcome_height": "Высота:",
    "welcome_import_mod": "Импорт карты МОДа",
...
Рисуйте континенты → Генерируйте провинции → Рельеф и высоты → Регионы и страны → Экспорт играбельного МОДа одним кликом.""",
    ...
    "welcome_size_picker_title": "Выберите размер карты",
    "welcome_title": "HOI4 Map Maker",
    "welcome_width": "Ширина:",
}
