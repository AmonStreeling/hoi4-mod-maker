...
STRINGS = {
    "nav_preview": "预览",
    "nav_tooltip_preview": "查看地图在游戏里的实际效果（使用游戏本体的地形贴图渲染，不用导出、不用开游戏）",
    "preview_page_title": "游戏效果预览",
    ...
    "preview_game_dir_invalid": "选择的文件夹里没有找到游戏文件（应包含 common/terrain/00_terrain.txt）。请选择《钢铁雄心4》的安装根目录。",
    "preview_choose_dir_btn": "选择游戏安装目录",
    "preview_choose_dir_title": "选择《钢铁雄心4》安装目录",
}
